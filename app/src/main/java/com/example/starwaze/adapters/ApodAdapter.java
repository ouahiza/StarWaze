...
public class ApodAdapter extends RecyclerView.Adapter<ApodAdapter.ViewHolder> {
    ...
    public ApodAdapter(List<Article> articles, Context context, OnArticleListener onArticleListener){
    ...
    @NotNull @Override
    public ApodAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                     int viewType) {
        // create a new view
